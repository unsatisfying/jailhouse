...
#define GPHYS2PHYS_WRITE       S2_PTE_ACCESS_WO
#define GPHYS2PHYS_WRITE_MASK  (0x2UL << 6)
#define GPHYS2PHYS_WRITE_PROTECTION_VALUE (0x0UL << 6)  
#define GPHYS2PHYS_WRITE_READ_VALUE S2_PTE_ACCESS_RW
#endif
